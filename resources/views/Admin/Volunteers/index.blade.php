        ...
        <div class="col-xxl-12">
            <div class="card stretch stretch-full">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        <h5 class="card-title mb-0">Volunteer List</h5>
                    </div>
                    <div class="d-flex align-items-center gap-2 mb-0">
                </div>
                    {{-- <a href="#" class="btn btn-primary ms-auto">Add New governing_body</a> --}}
                </div>
                            ...
                            <tbody>
                                @foreach ($volunteers as $volunteer)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <a href="javascript:void(0);">
                                                    <span class="d-block">{{ $volunteer->name }}</span>
                                                </a>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                           {{ $volunteer->created_at->format('d-m-Y h:i A') }}
                                        </td>
                                        {{-- <td></td> --}}
                                        {{-- <td class="text-end">
                                            <div class="hstack gap-2 justify-content-end">
                                                ...
                                                <a href="{{ route('admin.governing_body.edit',$volunteer->id) }}" class="avatar-text avatar-md">
                                                    <i class="feather-edit"></i>
                                                </a>

                                                <!-- Delete Form -->
                                                <form action="{{ route('admin.governing_body.destroy', $volunteer->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="card-footer">
                    ...
                    @if ($volunteers->hasPages())
                        <ul class="list-unstyled d-flex align-items-center gap-2 mb-0 pagination-common-style">
                            ...
                            @else
                                <li>
                                    <a href="{{ $volunteers->previousPageUrl() }}"><i class="bi bi-arrow-left"></i></a>
                                </li>
                            @endif

                            <!-- Page Numbers -->
                            @foreach ($volunteers->links()->elements as $element)
                                ...
                                @if (is_array($element))
                                    @foreach ($element as $page => $url)
                                        <li>
                                            <a href="{{ $url }}" class="{{ ($page == $volunteers->currentPage()) ? 'active' : '' }}">{{ $page }}</a>
                                        </li>
                                    @endforeach
                                @endif
                            @endforeach
                            ...
                            @if ($volunteers->hasMorePages())
                                <li>
                                    <a href="{{ $volunteers->nextPageUrl() }}"><i class="bi bi-arrow-right"></i></a>
                                </li>
                            @else
                                <li class="disabled">
